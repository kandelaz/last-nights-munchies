  ...
  "2026": {
    "05": {
      "22": [
        ...
        { number: 14, title: "Smokey Stoner Jam",                         filename: "14-smokey-stoner-jam.mp3" },
    ...
    "05": {
      "15": [
        { number: 1,  title: "We Drink",                               filename: "01-we-drink.mp3" },
        { number: 2,  title: "Low",                                    filename: "02-low.mp3" },
        { number: 3,  title: "Criss Cross of Chaos",                   filename: "03-criss-cross.mp3" },
        { number: 4,  title: "Turn Up the Bottle",                     filename: "04-turn-up-bottle.mp3" },
        { number: 5,  title: "Girl",                                   filename: "05-girl.mp3" },
        { number: 6,  title: "Ain't No Sunshine",                      filename: "06-aint-no-sunshine.mp3" },
        { number: 7,  title: "Dance Till You Die",                     filename: "07-new-ish-punky-one.mp3" },
        { number: 8,  title: "Drop D Jam",                             filename: "08-jam.mp3" },
        { number: 9,  title: "Love Sock",                              filename: "09-jam-guitar-intro-only.mp3" },
        { number: 10, title: "PB N Jam",                               filename: "10-new-one.mp3" },
        { number: 11, title: "PB N Jam (Slower Soft Drums Version)",   filename: "11-pb-jam.mp3" },
        { number: 12, title: "Good Days Good Times 1",                 filename: "12-good-days-good-times.mp3" },
        { number: 13, title: "Good Days Good Times 2",                 filename: "13-blowjob.mp3" },
        { number: 14, title: "Smokey Stoner Jam",                      filename: "14-jam-too-hot-for-hugs.mp3" },
        { number: 15, title: "Shitty Sailing (Bass & Guitar Only)",    filename: "15-shitty-sailing.mp3" },
        { number: 16, title: "Shitty Sailing",                         filename: "16-we-drink-2.mp3" },
      ],
    },
  },
};
